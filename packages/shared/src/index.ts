...
export const eventStatuses = ["pending", "confirmed", "cancelled", "completed"] as const;
export const assignmentRoles = ["technician", "assembler", "driver", "pickup_teardown", "support", "lead"] as const;
export const availabilityStatuses = ["pending", "approved", "rejected", "cancelled"] as const;
export const confirmationStatuses = ["pending_read", "read", "confirmed"] as const;
export const eventScheduleTypes = ["prueba", "montaje", "bolo", "desmontaje"] as const;
